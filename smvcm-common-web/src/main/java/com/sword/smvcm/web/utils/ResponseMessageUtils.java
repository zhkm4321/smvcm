...
/**
 * 创 建 人：gugu 创建日期：2015-06-08 修 改 人： 修改日 期： 描 述：Response工具类。
 */
public class ResponseMessageUtils {
   ...
   * @param content
   */
  public static void returnAjaxMessage(HttpServletResponse response, String content, String code) {
    response.setCharacterEncoding("UTF-8");
    String result = null;
    AjaxException message = new AjaxException(code, content);
