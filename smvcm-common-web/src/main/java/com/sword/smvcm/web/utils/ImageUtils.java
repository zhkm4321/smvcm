package com.sword.smvcm.web.utils;
...
import com.sword.smvcm.utils.FileUtils;
import com.sword.smvcm.utils.IDUtils;

/**
 * 创 建 人：gugu 创建日期：2015-05-25 修 改 人： 修改日 期： 描 述：图片操作工具类。
 */
public class ImageUtils {
   ...
   */
  public static void abscut(InputStream inputStream, int x, int y, int destWidth, int destHeight, int size,
  ...
  public static void resize(Image image, File resizedFile, int newWidth, float quality) throws IOException {
  ...
  public static void resize(ImageIcon ii, File resizedFile, int newWidth, float quality) throws IOException {
  ...
  public static void abscut(InputStream inputStream, int x, int y, int width, int height, File file)
      throws IOException {
