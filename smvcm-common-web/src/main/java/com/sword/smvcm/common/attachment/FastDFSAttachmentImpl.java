package com.sword.smvcm.common.attachment;
...
import com.sword.smvcm.web.utils.JsonUtils;

/**
 * 
 * @author zhenghang E-mail: zhenghang@unitedstone.net
 * @version 创建时间：2017年1月13日 上午11:12:17
 */
public class FastDFSAttachmentImpl implements AttachmentService {
  ...
  public String upload(InputStream inputStream, String type, String fileName) {
    ...
    /*
     * if(StringUtils.hasText(fileName)){ metaList=new NameValuePair[1];
