...
/**
 * 创 建 人：gugu 创建日期：2015-05-25 修 改 人： 修改日 期： 描 述：时间日期工具类。
 */
public class DateTimeUtils {
  ...
  public static String format(String dateString, String pattern, String desPattern) throws ParseException {
    if (StringUtils.isEmpty(pattern))
      pattern = "yyyy-MM-dd HH:mm:ss";
